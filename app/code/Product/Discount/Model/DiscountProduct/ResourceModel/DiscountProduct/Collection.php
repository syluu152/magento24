...
namespace Product\Discount\Model\DiscountProduct\ResourceModel\DiscountProduct;

use Magento\Framework\App\ObjectManager;
use Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection;
use Product\Discount\Model\DiscountProduct\ResourceModel\DiscountProduct;
...
class Collection extends AbstractCollection
{
    ...
    public function _construct()
    {
        ...
        $this->_init(\Product\Discount\Model\DiscountProduct\DiscountProduct::class, DiscountProduct::class);
    }
    ...
    public function getDiscountOfProduct(
        ...
        $discountFactory = $obj->get('Product\Discount\Model\Discount\ResourceModel\Discount\CollectionFactory');
